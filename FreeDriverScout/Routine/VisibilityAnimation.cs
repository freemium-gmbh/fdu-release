...
namespace FreeDriverScout
{
	...
	public class VisibilityAnimation
	{
		...
		/// </summary>
		static readonly Dictionary<FrameworkElement, bool> _hookedElements = new Dictionary<FrameworkElement, bool>();
		...
		static void OnAnimationTypePropertyChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
		{
		...
		static void HookVisibilityChanges(FrameworkElement frameworkElement)
		{
		...
		/// </summary>
		/// <param name="frameworkElement">Framework element</param>
		static void UnHookVisibilityChanges(FrameworkElement frameworkElement)
		{
		...
		/// <param name="dependencyObject">Dependency object</param>
		/// <param name="e">e</param>
		static void VisibilityChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
		{
			// Ignore
		}
		...
		static object CoerceVisibility(DependencyObject dependencyObject, object baseValue)
		{
			...
			// Start animation
			frameworkElement.BeginAnimation(UIElement.OpacityProperty, doubleAnimation, HandoffBehavior.SnapshotAndReplace);
		...
		static bool IsHookedElement(FrameworkElement frameworkElement)
		{
		...
		static bool UpdateAnimationStartedFlag(FrameworkElement frameworkElement)
		{
